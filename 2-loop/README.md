...
следующих четырёх байтах, потом будeт 296 нулевых байтов (0x130 - 4 - 4 = 304 -
4 - 4 = 296), а потом будут 2 инструкции по 4 байта, которые будут что-то
делать. Итого файл прошивки должен занимать 4 + 4 + 296 + 4 + 4 = 312 байтов.
Содержимое этого файла мы запишем в микроконтроллер по адресу 0x08000000, где и
